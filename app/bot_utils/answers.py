...
class Answers:
    ...
    you_can_fly: str = (
        "Вы можете улететь в город {destination} за {price} р.\n {weather}"
    )
    ...
    start: str = "Приветствую Вас!"
    city_or_location: str = (
        "Выберите Ваш город, или позвольте его определить  через геолокацию "
        "для дальнейшего поиска направлений и билетов!"
    )
    ...
    city_found = (
        "В качестве города отправления выбран {city_name} c аэропортом {airport_name}"
    )
    ...
    weather_wrong_city: str = (
        "Для города {city} нет данных. Проверьте название или введите другой город."
    )
